...
(function($) {
  ...
  $.sweetDropdown.attachAll = function() {
    ...
    // $('body').off('mouseover.dropdownover').on('mouseover.dropdownover', '[data-dropdownover]', showDropdown);
    // $('[data-dropdown]').off('mouseover.dropdownover').on('mouseover.dropdownover', showDropdown);
    // $('html, .sweet-modal-content').off('mouseout.dropdownover').on('mouseout.dropdownover', $.sweetDropdown.hideAll);
    // $(window).off('resize.dropdown').on('resize.dropdown', $.sweetDropdown.hideAll);
    return true;
  };
  ...
  showDropdown = function(e) {
    ...
    heightTrigger = $trigger.outerHeight() - 10;
